        ...
        <section class="card">
            ...
            <div class="grid-busca">
                ...
                <div class="dica-box">
                    ...
                    <p>
                        Para cadastrar um funcionário, primeiro informe o <strong>CPF</strong> e clique em
            ...
            <form id="form-dados" action="<?= $actionUrl ?>" method="POST">
                <div class="grid-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="whatsapp" placeholder="(XX) 00000-0000" oninput="mascaraTelefone(this)"
