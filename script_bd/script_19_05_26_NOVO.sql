...
(
    ...
    'CLT',
    'ativo',
    'Funcionário experiente em desenvolvimento web.'
),
(
    ...
    'CONTRATO TEMPORARIO',
    'ativo',
    'Atua no recrutamento e seleção.'
),
(
...
(
    ...
    'PESSOA JURÍRIDICA',
    'ativo',
    'Responsável pela identidade visual da empresa.'
),
(
    ...
    'CLT',
    'ativo',
    'Atendimento interno e suporte aos usuários.'
);
